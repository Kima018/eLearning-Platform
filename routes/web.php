...
//Blade for all lectures,can use user,mod,admin
Route::middleware(['auth'])->group(function () {
...
//blades and routs to edit, can use admin and mod
...
//- 	- Admin moze da dodaje predavanja, edituje i brise DONE
//- - Moderator moze da samo edituje predavanja DONE
//- - User moze da samo gleda predavanja DONE
